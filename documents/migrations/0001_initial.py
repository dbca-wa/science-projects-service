# Generated by Django 4.2.6 on 2023-11-29 20:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_time_allocation', models.TextField(blank=True, default='[["Role", "Year 1", "Year 2", "Year 3"], ["Scientist", "", "", ""], ["Technical", "", "", ""], ["Volunteer", "", "", ""], ["Collaborator", "", "", ""]]', help_text="Summarise staff time allocation by role for the first three years, or for a time span appropriate for the Project's life time", null=True)),
                ('budget', models.TextField(blank=True, default='[["Source", "Year 1", "Year 2", "Year 3"], ["Consolidated Funds (DBCA)", "", "", ""], ["External Funding", "", "", ""]]', help_text="Indicate the operating budget for the first three years, or for a time span appropriate for the Project's life time.", null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('intended_outcome', models.CharField(blank=True, choices=[('completed', 'Completed with final update'), ('forcecompleted', 'Completed w/o Final Update'), ('suspended', 'Suspended'), ('terminated', 'Terminated')], default='completed', help_text='The intended project status outcome of this closure', max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operating_budget', models.TextField(blank=True, default='[["Source", "Year 1", "Year 2", "Year 3"], ["FTE Scientist", "", "", ""], ["FTE Technical", "", "", ""], ["Equipment", "", "", ""], ["Vehicle", "", "", ""], ["Travel", "", "", ""], ["Other", "", "", ""], ["Total", "", "", ""]]', help_text='Estimated budget: consolidated DBCA funds', null=True)),
                ('operating_budget_external', models.TextField(blank=True, default='[["Source", "Year 1", "Year 2", "Year 3"], ["Salaries, Wages, Overtime", "", "", ""], ["Overheads", "", "", ""], ["Equipment", "", "", ""], ["Vehicle", "", "", ""], ["Travel", "", "", ""], ["Other", "", "", ""], ["Total", "", "", ""]]', help_text='Estimated budget: external funds', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(help_text='The year on which this progress report reports on with four digits, e.g. 2014 for FY 2013/14.')),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_report_details', to='documents.projectdocument')),
            ],
            options={
