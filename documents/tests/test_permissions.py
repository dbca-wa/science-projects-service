...
class TestCanViewDocument:
    ...
    def test_non_member_non_leader_cannot_view_when_no_division(self, project_document, user_factory, db):
...
class TestCanApproveDocument:
    ...
    def test_project_lead_can_approve_stage_1(self, project_document, user, project_member, db):
    ...
    def test_cannot_approve_stage_3_when_no_division(self, project_document, user_factory, db):
...
class TestCanRecallDocument:
    ...
    def test_cannot_recall_non_approval_status(self, project_document, user, project_member, db):
...
class TestCanDeleteDocument:
    ...
    def test_cannot_delete_approved_document(self, project_document, user, project_member, db):
