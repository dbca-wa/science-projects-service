...
from documents.utils.filters import (
...
class TestValidateApprovalStage:
    ...
    def test_valid_approval_stage(self, project_document):
        ...
        with patch.object(project_document, 'has_project_document_data', return_value=True):
    ...
    def test_missing_document_data(self, project_document):
        ...
        with patch.object(project_document, 'has_project_document_data', return_value=False):
...
class TestIsDocumentEditable:
    ...
    def test_only_leader_can_edit_in_approval(self, project_document, user, project_member):
...
class TestEmailTemplateRenderer:
    ...
    def test_render_template(self, mock_render):
        ...
        mock_render.assert_called_once_with('./email_templates/test.html', {'key': 'value'})
    ...
    @patch('documents.utils.email_templates.render_to_string')
    def test_render_document_email_unknown_type(self, mock_render, project_document, user):
...
class TestGetDocumentYearEdgeCases:
    ...
    def test_get_year_fallback_to_creation_year(self, project_document):
        ...
        assert result in [project_document.project.year, project_document.created_at.year]
