...
class TestProjectDocument:
    ...
    def test_has_project_document_data_concept_plan(self, concept_plan_with_details, db):
    ...
    def test_has_project_document_data_progress_report(self, progress_report_with_details, db):
    ...
    def test_has_project_document_data_student_report(self, student_report_with_details, db):
