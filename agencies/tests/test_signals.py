...
class TestUpdateProjectAffiliationsOnNameChange:
    ...
    @patch.object(settings, 'LOGGER')
    def test_affiliation_name_change_with_semicolon_delimited_field(self, mock_logger, db):
    ...
    def test_general_exception_logged(self, mock_logger, db):
        ...
        assert "Error updating project affiliations" in mock_logger.error.call_args[0][0]
