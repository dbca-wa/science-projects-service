...
from ..serializers import DepartmentalServiceSerializer, TinyDepartmentalServiceSerializer
...
class DepartmentalServiceDetail(APIView):
    ...
    def put(self, request, pk):
        service = AgencyService.get_departmental_service(pk)
        settings.LOGGER.info(f"{request.user} is updating departmental service detail {service}")
    ...
    def delete(self, request, pk):
        service = AgencyService.get_departmental_service(pk)
        settings.LOGGER.info(f"{request.user} is deleting departmental service detail {service}")
        service.delete()
