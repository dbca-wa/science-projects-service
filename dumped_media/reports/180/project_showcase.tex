...
\ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{SP 2012-018 WAMMP Sub-project 6: Marine information management system}}}
...
\hypersetup{
  ...
  pdftitle=SP 2012-018 WAMMP Sub-project 6: Marine information management system
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/scienceproject/180/}{%
    \includegraphics[width=\linewidth, , cfbox=black 0.5pt 0pt]{%
    /mnt/projects/sdis/staticfiles/img/intertidal.jpg}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{WAMMP Sub-project 6: Marine information management system
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{WAMMP Sub-project 6: Marine information management system
}
    SP 2012-018
    \label{sec:2012-018}
    ...
    S Whiting, K Friedman, S Whiting, F Mayer, C Douglass
...
\vskip 12 pt
KF advises folded into SPP 2012-008 - PG
