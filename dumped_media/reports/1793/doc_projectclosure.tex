...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Project Closure SP 2004-002}}}
...
\hypersetup{
  ...
  pdftitle=Project Closure SP 2004-002
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/projectclosure/1793/}{Project Closure SP 2004-002}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
\ohead{\href{https://www.dbca.wa.gov.au/science/10-biodiversity-and-conservation-science}{
\includegraphics[height=6mm, keepaspectratio]{/mnt/projects/sdis/staticfiles/img/logo-dbca-bcs.jpg}}}
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Wed, 28 Nov 2018 12:23:15 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Project Closure SP 2004-002
}
...
\end{tabu}
    ...
    \subsection*{Project status as of Nov. 28, 2018, 12:23 p.m.}
\begin{tabu} {X X}
...
\subsection*{Document endorsements and approvals as of Nov. 28, 2018, 12:23 p.m.}
\begin{tabu} {X X}
