...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Project Plan SP 2015-002}}}
...
\hypersetup{
  ...
  pdftitle=Project Plan SP 2015-002
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/projectplan/1314/}{Project Plan SP 2015-002}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Wed, 3 Jan 2018 11:03:36 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Project Plan SP 2015-002
}
...
\end{tabu}
    ...
    \subsection*{Project status as of Jan. 3, 2018, 11:03 a.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of Jan. 3, 2018, 11:03 a.m.}
\begin{tabu} {X X}
...
Supervising Scientist & Jim Lane & 0.3\\

Research Scientist & Mike Lyons & 0.3\\

Research Scientist & Adrian Pinder & 0.1\\

Technical Officer & Alan Clarke & 0.7\\

Technical Officer & David Cale & 0.4\\

Technical Officer & Yvonne Winchcombe & 0.4\\
