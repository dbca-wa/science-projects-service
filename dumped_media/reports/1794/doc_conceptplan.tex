...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Concept Plan SP 2017-001}}}
...
\hypersetup{
  ...
  pdftitle=Concept Plan SP 2017-001
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/conceptplan/1794/}{Concept Plan SP 2017-001}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
\ohead{\href{https://www.dbca.wa.gov.au/science/10-biodiversity-and-conservation-science}{
\includegraphics[height=6mm, keepaspectratio]{/mnt/projects/sdis/staticfiles/img/logo-dbca-bcs.jpg}}}
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Thu, 3 Jan 2019 15:53:17 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Concept Plan SP 2017-001
}
...
\end{tabu}
    ...
    \subsection*{Project status as of Jan. 3, 2019, 3:53 p.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of Jan. 3, 2019, 3:53 p.m.}
\begin{tabu} {X X}
...
The project will have immediate benefits in reducing python predation.
Various techniques will be trialled to locate pythons that will have
value in the future both for ecological work on pythons but also in
curtailing python predation of threatened mammals (or birds, or
reptiles) in other situations. Consequently, the information could be
used by other researchers/ managers with predation problems within
enclosures or in wild populations both in WA and elsewhere.

Techniques to locate pythons will be trialled and transfer of this
information to operations staff will occur directly during the project.
Information collected will be reported in refereed scientific journals
and in internal reports and flyers to staff.
...
The project would involve working with South Coast regional staff,
Department of Defence environmental staff (for trials of capture boxes
on Garden Island) and amateur herpetologists/ volunteers who would be
recruited to help locate pythons.
...
Consolidated Funds (DPaW) & 20 000 & 14500 & 15000\\
