...
\usepackage[
    ...
    pdftitle=Project Closure SP 2001-005
]{hyperref}
...
% Headers and Footers
\automark{section}
\ohead{\href{http://sdis.dpaw.wa.gov.au/documents/projectclosure/1772/}{Project Closure SP 2001-005
}}
\chead{\href{http://sdis.dpaw.wa.gov.au}{SDIS}} % center header ONLINE
\ihead{\href{http://sdis.dpaw.wa.gov.au}{
        \includegraphics[scale=0.4]{/mnt/projects/sdis/staticfiles/img/logo-dpaw.png}}}
\ifoot{\textbf{Printed}~Wed, 20 Jul 2016 18:16:23 +0800} % inner/left footer
\cfoot{} % center footer
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Project Closure SP 2001-005
}
...
\end{tabu}
    ...
    \subsection*{Project status as of July 20, 2016, 6:16 p.m.}
\begin{tabu} {X X}
& Suspended
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of July 20, 2016, 6:16 p.m.}
\begin{tabu} {X X}
