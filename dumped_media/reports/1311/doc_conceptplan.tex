...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Concept Plan SP 2015-001}}}
...
\hypersetup{
  ...
  pdftitle=Concept Plan SP 2015-001
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/conceptplan/1311/}{Concept Plan SP 2015-001}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Mon, 23 Oct 2017 09:34:05 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Concept Plan SP 2015-001
}
...
\end{tabu}
    ...
    \subsection*{Project status as of Oct. 23, 2017, 9:34 a.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of Oct. 23, 2017, 9:34 a.m.}
\begin{tabu} {X X}
