...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{CF 2011-119 Understanding the early offshore migration patterns of turtle hatchlings and the effects of anthropogenic light}}}
...
\hypersetup{
  ...
  pdftitle=CF 2011-119 Understanding the early offshore migration patterns of
turtle hatchlings and the effects of anthropogenic light
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/corefunctionproject/160/}{%
    \includegraphics[width=\linewidth, cfbox=black 0.5pt 0pt]{./media/projects/2011-119/greenhatchling.jpg}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{Understanding the early offshore migration patterns of turtle hatchlings
and the effects of anthropogenic light
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{Understanding the early offshore migration patterns of turtle hatchlings
and the effects of anthropogenic light
}
    % CF 2011-119
    % \label{sec:2011-119}
...
\vskip 12 pt
\textbf{Status} pilot study, external project, closed.
