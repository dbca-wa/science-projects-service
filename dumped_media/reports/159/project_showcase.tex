...
\ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{CF 2011-118 North West Shelf Flatback Turtle Conservation Program strategic plan}}}
...
\hypersetup{
  ...
  pdftitle=CF 2011-118 North West Shelf Flatback Turtle Conservation Program
strategic plan
,
  colorlinks=true,
  linkcolor=dpawblue,
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/corefunctionproject/159/}{%
    \includegraphics[width=\linewidth, cfbox=black 0.5pt 0pt]{./media/projects/2011-118/flatback_1.jpg}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{North West Shelf Flatback Turtle Conservation Program strategic plan
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{North West Shelf Flatback Turtle Conservation Program strategic plan
}
    CF 2011-118
    \label{sec:2011-118}
    ...
    S Whiting, S Fossette-Halot, T Tucker
