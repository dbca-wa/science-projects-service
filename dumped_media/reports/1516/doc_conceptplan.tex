...
\usepackage[
    ...
    pdftitle=Concept Plan SP 2015-020
]{hyperref}
...
% Headers and Footers
\automark{section}
\ohead{\href{http://sdis.dpaw.wa.gov.au/documents/conceptplan/1516/}{Concept Plan SP 2015-020
}}
\chead{\href{http://sdis.dpaw.wa.gov.au}{SDIS}} % center header ONLINE
\ihead{\href{http://sdis.dpaw.wa.gov.au}{
        \includegraphics[scale=0.4]{/mnt/projects/sdis/staticfiles/img/logo-dpaw.png}}}
\ifoot{\textbf{Printed}~Mon, 29 Aug 2016 15:34:14 +0800} % inner/left footer
\cfoot{} % center footer
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Concept Plan SP 2015-020
}
\title{Recovery of the Dibbler~\emph{Parantechinus}~\emph{apicalis}
}
...
\end{tabu}
    ...
    \subsection*{Project status as of Aug. 29, 2016, 3:34 p.m.}
\begin{tabu} {X X}
...
\subsection*{Document endorsements and approvals as of Aug. 29, 2016, 3:34 p.m.}
\begin{tabu} {X X}
...
\section*{Recovery of the Dibbler~\emph{Parantechinus}~\emph{apicalis}
}
