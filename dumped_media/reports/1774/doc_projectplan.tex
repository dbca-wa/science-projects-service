...
% \ihead{\href{http://sdis.dbca.wa.gov.au}{\textbf{Project Plan SP 2015-018}}}
...
\hypersetup{
  ...
  pdftitle=Project Plan SP 2015-018
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dbca.wa.gov.au/documents/projectplan/1774/}{Project Plan SP 2015-018}}
%\chead{\href{http://sdis.dbca.wa.gov.au}{Science Directorate Information System}}
\ohead{\href{https://www.dbca.wa.gov.au/science/10-biodiversity-and-conservation-science}{
\includegraphics[height=6mm, keepaspectratio]{/usr/src/app/staticfiles/img/logo-dbca-bcs.jpg}}}
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Tue, 16 Jun 2020 09:52:02 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Project Plan SP 2015-018
}
...
\end{tabu}
    ...
    \subsection*{Project status as of June 16, 2020, 9:52 a.m.}
\begin{tabu} {X X}
...
\subsection*{Document endorsements and approvals as of June 16, 2020, 9:52 a.m.}
\begin{tabu} {X X}
...
Supervising Scientist & Mark Cowan & 0.0\\

Research Scientist & Lesley Gibson & 0.0\\

Supervising Scientist & David Pearson & 0.2\\
