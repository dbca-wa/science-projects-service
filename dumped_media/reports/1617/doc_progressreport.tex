...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Progress Report SP 2012-032 (FY 2015-2016)}}}
...
\hypersetup{
  ...
  pdftitle=Progress Report SP 2012-032 (FY 2015-2016)
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/progressreport/1617/}{Progress Report SP 2012-032 (FY 2015-2016)}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Tue, 24 Jul 2018 09:59:57 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
%-----------------------------------------------------------------------------%
% Title page
\subject{Progress Report SP 2012-032
}
\title{Biological survey and conservation planning for the Swan Coastal Plain
bioregion and adjacent scarps (Dandaragan, Darling and Whicher)
}
...
\end{tabu}
    ...
    \subsection*{Project status as of July 24, 2018, 9:59 a.m.}
\begin{tabu} {X X}
& Update requested
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of July 24, 2018, 9:59 a.m.}
\begin{tabu} {X X}
...
\section*{Biological survey and conservation planning for the Swan Coastal Plain
bioregion and adjacent scarps (Dandaragan, Darling and Whicher)
}
...
The Swan Coastal bioregion is highly fragmented and impacted by
settlement, urbanisation and industry. Detailed biological data at
various levels is required to inform complex decisions on land use to
conserve and protect biodiversity. This project delivers new data for
the Swan Coastal bioregion and adjacent scarps (Dandaragan, Darling and
Whicher)~to the relevant regulatory and statutory planning agencies,
local government authorities and the community on the botanical values
of uncleared land in the bioregion.
...
\item
  Prepare a new 1: 250,000 and 1: 50,000 vegetation complex maps for the
  Swan Coastal Plain.
\item
  Prepare reports and publications on conservation reserves and offset
  acquisitions (proposed and actual).
\item
  Using volunteers, survey and report on areas of interest for
  conservation planning of the Perth region and greater Swan Coastal
  Plain IBRA region.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  Vegetation complex mapping of Bunbury to Busselton published in press.
\item
  Paper on Lambert Lane Nature Reserve published.
\item
  2015 surveys of South Bunbury, Ioppollo Road and Harrisdale Swamp
  undertaken.
\item
  Discussion paper on vegetation complex mapping prepared for funding
  proposal.
\item
  Review paper on floristics of Banksia woodlands in press.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  A better understanding of the conservation values of remnant and
  intact bushland areas forms the basis for improved land use planning
  and decision making for biodiversity conservation and natural resource
  management on the Swan Coastal Plain, including the Perth and Peel
  Green Growth Plan.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  Update information on and complete monitoring sites for the south
  Bunbury greenways corridor using volunteers in association with South
  West Catchment Council (SWCC), City of Bunbury and the Department of
  Parks and Wildlife's South West Region in spring 2016.
\end{itemize}
