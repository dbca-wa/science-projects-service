...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{CF 2011-105 Herbarium collections management}}}
...
\hypersetup{
  ...
  pdftitle=CF 2011-105 Herbarium collections management
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/corefunctionproject/150/}{%
    \includegraphics[width=\linewidth, cfbox=black 0.5pt 0pt]{./media/projects/2011-105/herb_picsdis.jpg}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{Herbarium collections management
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{Herbarium collections management
}
    % CF 2011-105
    % \label{sec:2011-105}
...
Falconer , E Wood-Ward , M Hislop , R Davis
