...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{SP 2011-020 Long-term stand dynamics of regrowth forest in relation to site productivity and climate}}}
...
\hypersetup{
  ...
  pdftitle=SP 2011-020 Long-term stand dynamics of regrowth forest in relation to
site productivity and climate
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
                % insert project image or link to add one
    %% we are depending on MEDIA_ROOT being symlinked to the report directory
    \href{http://sdis.dpaw.wa.gov.au/projects/scienceproject/144/}{%
    \includegraphics[width=\linewidth, cfbox=black 0.5pt 0pt]{./media/projects/2011-20/Inglehope_thinning_experiment_1.jpg}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{Long-term stand dynamics of regrowth forest in relation to site
productivity and climate
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{Long-term stand dynamics of regrowth forest in relation to site
productivity and climate
}
    % SP 2011-020
    % \label{sec:2011-020}
...
\vskip 12 pt
5 (d) Plot/transect geocode(s) / location: Plot locations specified in
the Scientific Sites Register. Barker Rd, Warren block March Rd, Sutton
block Vasse Hwy, Treen Brook block Amp Rd, Nairn block Drum Rd, Wheatley
block, Inglehope 5 (e) Plot/transect protection requirements (fire,
logging, earthworks, dieback etc.) Protection requirements are specified
