...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Progress Report SP 2013-003 (FY 2016-2017)}}}
...
\hypersetup{
  ...
  pdftitle=Progress Report SP 2013-003 (FY 2016-2017)
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/progressreport/1817/}{Progress Report SP 2013-003 (FY 2016-2017)}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Fri, 8 Jun 2018 15:08:07 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
\begin{tabu} {X X}
\textbf{Supervising Scientist} & Stephen van Leeuwen
\\
...
\end{tabu}
    ...
    \subsection*{Project status as of June 8, 2018, 3:08 p.m.}
\begin{tabu} {X X}
...
\subsection*{Document endorsements and approvals as of June 8, 2018, 3:08 p.m.}
\begin{tabu} {X X}
...
S van Leeuwen, N Gibson, M Byrne, M Langley
...
\item
  ...
  recommendations.
\item
  Determine whether soil community turnover reflects plant community
  turnover.
\item
  Determine whether isotope analysis indicated species sensitivity to
  climate gradients.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  Data on the floristics and vegetation communities of sand plains has
  been analysed and a paper describing turnover published in \emph{PLoS
  ONE}.
\item
  Plant specimens have been lodged in the Western Australian Herbarium.
\item
  Metagenomic DNA sequencing has been undertaken from soil samples from
  plots.
\item
  Laboratory analysis of 43 species occurring in six or more plots along
  the transect has been undertaken to determine community isotope
  signature. Isotope analysis for 50 sample of \emph{Eucalyptus
  salmonophloia} and \emph{E. salubris} has been undertaken to determine
  signatures for widespread species.
\end{itemize}
...
vegetation structural attributes of the sand plains will enable improved
assessment of impacts of development proposals on biodiversity values;
assessment of effects of current fire management practices on
biodiversity values; development of a more accurate assessment of the
current reservation status of the sand plain vegetation types; better
understanding of the conservation status of many species restricted to
sand plain habitats; and greater understanding of the resilience of
species and sand plain vegetation communities to impacts of climate
change.
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  Complete isotopic signature data analysis in collaboration with
  Adelaide University and publish results.
\item
  Locate additional long-term sampling plots on the SWATT in
  collaboration with the Terrestrial Ecosystems Research Networks'
  AusPlots Facility as funding permits.
\item
  Complete analysis of metagenomic samples in conjunction with other
  transects in the Australian Transects Network.
\end{itemize}
