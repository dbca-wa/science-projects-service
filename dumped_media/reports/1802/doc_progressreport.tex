...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Progress Report SP 2015-015 (FY 2016-2017)}}}
...
\hypersetup{
  ...
  pdftitle=Progress Report SP 2015-015 (FY 2016-2017)
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/progressreport/1802/}{Progress Report SP 2015-015 (FY 2016-2017)}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Thu, 7 Jun 2018 12:13:06 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
\title{Long-term monitoring in the proposed Dampier Archipelago marine reserves
}
...
\end{tabu}
    ...
    \subsection*{Project status as of June 7, 2018, 12:13 p.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of June 7, 2018, 12:13 p.m.}
\begin{tabu} {X X}
