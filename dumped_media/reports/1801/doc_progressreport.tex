...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Progress Report SP 2015-016 (FY 2016-2017)}}}
...
\hypersetup{
  ...
  pdftitle=Progress Report SP 2015-016 (FY 2016-2017)
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/progressreport/1801/}{Progress Report SP 2015-016 (FY 2016-2017)}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Wed, 10 Oct 2018 11:31:35 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
\end{tabu}
    ...
    \subsection*{Project status as of Oct. 10, 2018, 11:31 a.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of Oct. 10, 2018, 11:31 a.m.}
\begin{tabu} {X X}
...
The northern quoll (\emph{Dasyurus hallucatus}) is one of a suite of
...
The development of the \emph{Eradicat\textsuperscript{®}} bait has
provided the opportunity to control feral cats at a landscape scale in
the southwest of Western Australia but questions remain as to the
potential risks of broadscale cat baiting programs on northern quolls
and other native carnivores in the Pilbara. The trial baiting program
undertaken on the Yarraloola pastoral lease in 2015 demonstrated that
the \emph{Eradicat\textsuperscript{®}} bait presents a low risk to
northern quolls. Based on this evidence, the project has entered phase
two, the large scale implementation of
\emph{Eradicat\textsuperscript{®}} baiting trials over 145 000 ha of
Yarraloola on an annual basis until at least 2019. Monitoring programs
will measure its success in reducing cat numbers and the recovery of
priority species, including the northern quoll.
...
\item
  Assess the field uptake of \emph{Eradicat\textsuperscript{®}} feral
  cat baits by northern quoll and impact on survivorship in the Pilbara.
\item
  Develop an effective cat control strategy that will benefit the
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  A research permit was granted by Australian Pesticides and Veterinary
  Medicines Authority to aerial bait \textasciitilde{}150 000 ha of
  Yarraloola with\emph{Eradicat\textsuperscript{®}} annually, until
  2019.
\item
  Sixty camera trap sites were set on both Yarraloola (baited) and Red
  Hill (reference site) for 25 nights both before and after baits were
  distributed to monitor feral cat occupancy.
\item
  \emph{Eradicat®} feral cat baiting of 144 000 ha area on Yarraloola
  was undertaken. Monitoring of individual \emph{Eradicat®}baits using
  camera traps indicated few non-target species took these baits.
  Northern quolls did sample the occasional bait but learnt very rapidly
  to ignore them (i.e. become bait-shy). There was no evidence quolls
  were harmed by sampling toxic baits.
\item
  Northern quoll populations were monitored at 18 trapping sites at both
  Yarraloola and Red Hill. Capture rates of quolls on both properties
  were equally low, with quolls continuing to survive and breed within
  the baited area with no apparent negative impacts.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  The lack of impact of \emph{Eradicat®} on northern quolls in the
  Pilbara has means that landscape control of feral cats using aerial
  baiting with \emph{Eradicat®} can be used for feral cat management in
  areas where this species occurs in Northern Australia.
\item
  Development of sound trapping methodology for monitoring northern
  quoll numbers in areas of relatively low abundance will improve
  monitoring of threat abatement programs.
\end{itemize}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  The broadscale \emph{Eradicat\textsuperscript{®}} feral cat baiting
  program will continue over Yarraloola on an annual basis until at
  least 2019.
\item
  Continue the use of camera traps in a before-after-control-impact
  (BACI) design to monitor the effect of
  \emph{Eradicat\textsuperscript{®}} baiting on feral cats at
  Yarraloola.
\item
  Continue monitoring northern quolls using established trapping sites
  at both Yarraloola and Red Hill to detect changes in population size
