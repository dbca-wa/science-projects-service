...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{SP 2011-003 Spatial variation in the functional morphology of mangroves in the Shark Bay World Heritage Area}}}
...
\hypersetup{
  ...
  pdftitle=SP 2011-003 Spatial variation in the functional morphology of mangroves
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/scienceproject/128/}{%
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{Spatial variation in the functional morphology of mangroves in the Shark
Bay World Heritage Area
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{Spatial variation in the functional morphology of mangroves in the Shark
Bay World Heritage Area
}
    % SP 2011-003
    % \label{sec:2011-003}
