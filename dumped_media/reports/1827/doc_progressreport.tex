...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{Progress Report SP 2012-029 (FY 2016-2017)}}}
...
\hypersetup{
  ...
  pdftitle=Progress Report SP 2012-029 (FY 2016-2017)
,
  colorlinks=true,
  linkcolor=dpawblue,
  pdfborder={0 0 0}}
...
% Header (inner, center, outer)
\ihead{\href{http://sdis.dpaw.wa.gov.au/documents/progressreport/1827/}{Progress Report SP 2012-029 (FY 2016-2017)}}
%\chead{\href{http://sdis.dpaw.wa.gov.au}{Science Directorate Information System}}
...
% Footer (inner, center, outer)
\ifoot{\textbf{Printed}~Thu, 15 Feb 2018 08:55:16 +0800} % inner/left footer
\cfoot{}
\ofoot[\bfseries\thepage]{\bfseries\thepage}        % Page number (also [plain])
...
\end{tabu}
    ...
    \subsection*{Project status as of Feb. 15, 2018, 8:55 a.m.}
\begin{tabu} {X X}
& Approved and active
\\
\end{tabu}
...
\subsection*{Document endorsements and approvals as of Feb. 15, 2018, 8:55 a.m.}
\begin{tabu} {X X}
