...
% \ihead{\href{http://sdis.dpaw.wa.gov.au}{\textbf{CF 2011-111 The Western Australian Plant Census and Australian Plant Census}}}
...
\hypersetup{
  ...
  pdftitle=CF 2011-111 The Western Australian Plant Census and Australian Plant
Census
,
  colorlinks=true,
  linkcolor=dpawblue,
...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \href{http://sdis.dpaw.wa.gov.au/projects/corefunctionproject/155/}{%
    \includegraphics[width=\linewidth, cfbox=black 0.5pt 0pt]{./media/projects/2011-111/A__viridis_3042d_1.png}}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{The Western Australian Plant Census and Australian Plant Census
}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{The Western Australian Plant Census and Australian Plant Census
}
    % CF 2011-111
    % \label{sec:2011-111}
    ...
    % \vskip 3pt
    % 
    % C Parker , J Percy-Bower , R Rees , M Falconer , E Wood-Ward , S Coffey
, T Macfarlane , K Knight
