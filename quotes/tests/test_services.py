...
class TestQuoteFileOperations:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='Quote 1 - Author 1\nQuote 2 - Author 2\n')
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='Quote with - multiple - dashes - Author\n')
    def test_load_quotes_handles_multiple_dashes(self, mock_file, db):
        ...
        # Assert
        assert len(quotes) == 1
        assert quotes[0] == {'text': 'quote with - multiple - dashes', 'author': 'author'}
