...
urlpatterns = [
    ...
    path(
        "requests", views.CaretakerRequestList.as_view(), name="caretaker-request-list"
    ),  # GET incoming
    path(
        "requests/outgoing",
        views.CaretakerOutgoingRequestList.as_view(),
        name="caretaker-outgoing-request-list",
    ),  # GET outgoing
    path(
        "requests/create",
        views.CaretakerRequestCreate.as_view(),
        name="caretaker-request-create",
    ),  # POST
    path(
        "requests/<int:pk>/approve",
        views.ApproveCaretakerRequest.as_view(),
        name="approve-request",
    ),
    path(
        "requests/<int:pk>/reject",
        views.RejectCaretakerRequest.as_view(),
        name="reject-request",
    ),
    path(
        "requests/<int:pk>/cancel",
        views.CaretakerRequestCancel.as_view(),
        name="cancel-request",
    ),
    # Caretaker tasks
    path(
        "tasks/<int:pk>",
        views.CaretakerTasksForUser.as_view(),
        name="caretaker-tasks-user",
    ),
    # Caretaker utilities
