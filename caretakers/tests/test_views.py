...
class TestCaretakerList:
    ...
    @pytest.mark.django_db
    def test_list_caretakers_authenticated(self, api_client, caretaker_user, caretakee_user, caretaker_assignment):
    ...
    @pytest.mark.django_db
    def test_create_caretaker_authenticated(self, api_client, caretaker_user, caretakee_user):
...
class TestCaretakerDetail:
    ...
    @pytest.mark.django_db
    def test_get_caretaker_authenticated(self, api_client, caretaker_user, caretaker_assignment):
    ...
    @pytest.mark.django_db
    def test_update_caretaker_authenticated(self, api_client, caretaker_user, caretaker_assignment):
    ...
    @pytest.mark.django_db
    def test_update_caretaker_partial_update(self, api_client, caretaker_user, caretaker_assignment):
    ...
    @pytest.mark.django_db
    def test_delete_caretaker_authenticated(self, api_client, caretaker_user, caretaker_assignment):
...
class TestCaretakerTasksForUser:
    ...
    @pytest.mark.django_db
    def test_get_tasks_with_directorate_documents(self, api_client, db, directorate_user):
...
class TestCheckCaretaker:
    ...
    @pytest.mark.django_db
    def test_check_caretaker_with_active_caretaker(self, api_client, caretaker_user, caretakee_user, caretaker_assignment):
...
class TestAdminSetCaretaker:
    ...
    @pytest.mark.django_db
    def test_admin_set_caretaker_requires_admin(self, api_client, caretaker_user, caretakee_user):
