...
urlpatterns = [
    ...
    path("", LegacyEndpointView(views.CaretakerList).as_view(), name="caretaker-list-compat"),
    path("<int:pk>", LegacyEndpointView(views.CaretakerDetail).as_view(), name="caretaker-detail-compat"),
    
    # Old: /api/v1/adminoptions/caretakers/pending/<int:pk>
    # New: /api/v1/caretakers/tasks/<int:pk>/
    path("pending/<int:pk>", LegacyEndpointView(views.CaretakerTasksForUser).as_view(), name="caretaker-tasks-compat"),
    
    # Old: /api/v1/adminoptions/caretakers/requests
    # New: /api/v1/caretakers/requests/
    path("requests", LegacyEndpointView(views.CaretakerRequestList).as_view(), name="caretaker-requests-compat"),
    
    # Old: /api/v1/adminoptions/caretakers/adminsetcaretaker
    # New: /api/v1/caretakers/admin-set/
    path("adminsetcaretaker", LegacyEndpointView(views.AdminSetCaretaker).as_view(), name="admin-set-caretaker-compat"),
    
    # Old: /api/v1/adminoptions/caretakers/checkcaretaker
    # New: /api/v1/caretakers/check/
    path("checkcaretaker", LegacyEndpointView(views.CheckCaretaker).as_view(), name="check-caretaker-compat"),
]
