...
class HTTPMethodsTestCase(TestCase):
    ...
    def test_patch_request_no_500_error(self):
        ...
        self.assertNotEqual(
            response.status_code, 500,
            "PATCH request should not cause 500 error"
        )
    ...
    def test_delete_request_no_500_error(self):
        ...
        self.assertNotEqual(
            response.status_code, 500,
            "DELETE request should not cause 500 error"
        )
    ...
    def test_get_request_works(self):
        ...
        self.assertIn(
            response.status_code, [200, 401, 403],
    ...
    def test_post_request_works(self):
        ...
        self.assertNotEqual(
            response.status_code, 500,
            "POST request should not cause 500 error"
        )
