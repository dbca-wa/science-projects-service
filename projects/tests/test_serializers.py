...
class TestProjectSerializer:
    ...
    def test_get_areas_empty(self, db):
        ...
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=1)
    ...
    def test_get_areas_with_areas(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=2)
        project = Project.objects.create(
            title='Test Project',
            kind='science',
            status='new',
        ...
        area1 = Area.objects.create(name='Area 1', area_type='dbcaregion', old_id=1)
        area2 = Area.objects.create(name='Area 2', area_type='dbcaregion', old_id=2)
...
class TestProjectDetailViewSerializer:
    ...
    @pytest.mark.skip(reason="Cannot test None project - ProjectDetail requires project on creation")
    def test_get_project_none(self, project, db):
        """Test get_project returns None when project is None"""
        # This edge case cannot be tested because ProjectDetail.project is required
        # and cannot be set to None after creation
        pass
...
class TestProjectAreaSerializer:
    ...
    def test_serialization_with_areas(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=3)
        project = Project.objects.create(
            title='Test Project',
            kind='science',
            status='new',
    ...
    def test_serialization_empty_areas(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=4)
        project = Project.objects.create(
            title='Test Project',
            kind='science',
            status='new',
...
class TestARProjectSerializer:
    ...
    def test_serialization_with_image(self, project, db):
        ...
        assert data['image']['file'] == 'test.jpg'
...
class TestARExternalProjectSerializer:
    ...
    def test_get_partners_without_external_info(self, project_with_lead, project_lead, db, capsys):
    ...
    def test_get_funding_without_external_info(self, project_with_lead, project_lead, db, capsys):
...
class TestProjectDataTableSerializer:
    ...
    def test_get_role_not_in_context(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=5)
    ...
    def test_get_description_external_project(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=6)
        project = Project.objects.create(
    ...
    def test_get_description_external_project_no_info(self, db):
        ...
        agency = Agency.objects.create(name='Test Agency')
        business_area = BusinessArea.objects.create(name='Test BA', agency=agency, old_id=7)
        project = Project.objects.create(
            title='External Project',
            kind='external',
            status='new',
