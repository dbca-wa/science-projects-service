...
class DetailsService:
    ...
    def create_student_details(project_id, data, user):
        ...
        """
        settings.LOGGER.info(f"{user} is creating student details for project {project_id}")
    ...
    def update_student_details(project_id, data, user):
        ...
        settings.LOGGER.info(f"{user} is updating student details for project {project_id}")
    ...
    def create_external_details(project_id, data, user):
        ...
        """
        settings.LOGGER.info(f"{user} is creating external details for project {project_id}")
        
        details = ExternalProjectDetails.objects.create(
            project_id=project_id,
            collaboration_with=data.get('collaboration_with', '<p>NO COLLABORATOR SET</p>'),
    ...
    def update_external_details(project_id, data, user):
        ...
        settings.LOGGER.info(f"{user} is updating external details for project {project_id}")
