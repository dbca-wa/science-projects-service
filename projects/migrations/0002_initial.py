...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='area', to='projects.project'),
        ),
        migrations.AddField(
            model_name='project',
            name='business_area',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='agencies.businessarea'),
        ),
        migrations.AddField(
            model_name='externalprojectdetails',
            name='project',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='external_project_info', to='projects.project'),
        ),
