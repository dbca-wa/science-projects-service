...
class TestApiUrlFunction:
    ...
    def test_app_with_nested_path(self):
        ...
        assert api_url('documents', 'reports/download') == '/api/v1/documents/reports/download'
        assert api_url('projects', 'areas/types') == '/api/v1/projects/areas/types'
    
    def test_app_with_id(self):
        """Test URL with ID in path"""
        assert api_url('documents', 'conceptplans/123') == '/api/v1/documents/conceptplans/123'
...
class TestAPIUrlBuilder:
    ...
    def test_path_multiple_parts(self):
        ...
        assert builder.path('reports', 'download') == '/api/v1/documents/reports/download'
        assert builder.path('reports', 456, 'generate_pdf') == '/api/v1/documents/reports/456/generate_pdf'
...
class TestRealWorldUsage:
    ...
    def test_nested_resources(self):
        ...
        assert projects_urls.path(123, 'members', 456) == '/api/v1/projects/123/members/456'
        ...
        assert documents_urls.path('reports', 789, 'generate_pdf') == '/api/v1/documents/reports/789/generate_pdf'
    ...
    def test_action_endpoints(self):
        ...
        assert documents_urls.path('actions', 'approve') == '/api/v1/documents/actions/approve'
