...
class TestAddressViews:
    ...
    def test_list_addresses_authenticated(self, api_client, user, address_for_agency, db):
    ...
    def test_get_address_detail(self, api_client, user, address_for_agency, db):
        ...
        # Act
        response = api_client.get(contacts_urls.path(f'addresses/{address_for_agency.id}'))
...
class TestAgencyContactViews:
    ...
    def test_list_agency_contacts_authenticated(self, api_client, user, agency_contact, db):
    ...
    def test_update_agency_contact(self, api_client, user, agency_contact, db):
        ...
        # Act
        response = api_client.put(
            contacts_urls.path(f'agencies/{agency_contact.id}'),
            data,
            format='json'
        )
...
class TestBranchContactViews:
    ...
    def test_list_branch_contacts_authenticated(self, api_client, user, branch_contact, db):
    ...
    def test_update_branch_contact(self, api_client, user, branch_contact, db):
        ...
        # Act
        response = api_client.put(
            contacts_urls.path(f'branches/{branch_contact.id}'),
            data,
            format='json'
        )
...
class TestUserContactViews:
    ...
    def test_update_user_contact(self, api_client, user, user_contact, db):
        ...
        # Act
        response = api_client.put(
            contacts_urls.path(f'users/{user_contact.id}'),
            data,
            format='json'
        )
...
class TestUserContactDetailPermissions:
    ...
    def test_get_user_contact_detail_unauthenticated(self, api_client, user_contact, db):
