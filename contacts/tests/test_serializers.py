...
class TestAddressSerializer:
    ...
    def test_validation_branch_uniqueness(self, branch, address_for_branch, db):
        ...
        assert 'An address with the same branch already exists' in str(serializer.errors)
    ...
    def test_get_agency_method(self, address_for_agency, db):
        ...
        assert agency_data['key_stakeholder'] == address_for_agency.agency.key_stakeholder
