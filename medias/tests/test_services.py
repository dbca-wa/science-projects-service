...
class TestProjectPhotoService:
    ...
    def test_update_project_photo_as_uploader(self, project_photo, user, mock_image, db):
    ...
    def test_update_project_photo_as_superuser(self, project_photo, superuser, mock_image, db):
...
class TestMethodologyPhotoService:
    ...
    def test_update_methodology_photo_not_found(self, user, db):
        ...
        # Act & Assert
        with pytest.raises(NotFound, match="Methodology photo for project plan 999 not found"):
...
class TestAgencyImageService:
    ...
    def test_update_agency_image_as_superuser(self, agency_image, superuser, mock_image, db):
...
class TestUserAvatarService:
    ...
    def test_update_user_avatar_as_superuser(self, user_avatar, superuser, mock_image, db):
