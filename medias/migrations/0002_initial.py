...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='project_plan',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='methodology_image', to='documents.projectplan'),
        ),
        migrations.AddField(
            model_name='projectplanmethodologyphoto',
            name='uploader',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='methodology_photos_uploaded', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
