...
class TestComment:
    ...
    def test_comment_get_reactions_with_reactions(self, comment, reaction_on_comment, db):
...
class TestReaction:
    ...
    def test_reaction_str_with_direct_message(self, reaction_on_message, direct_message, db):
    ...
    def test_reaction_clean_with_both_comment_and_message(self, user, comment, direct_message, db):
    ...
    def test_reaction_direct_message_relationship(self, reaction_on_message, direct_message, db):
