...
class TestApproveTask:
    ...
    def test_approve_delete_project_task(
        ...
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_delete_project.id, "approve")
        )
    ...
    def test_approve_merge_user_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_merge_user.id, "approve")
        )
    ...
    def test_approve_set_caretaker_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_set_caretaker.id, "approve")
        )
...
class TestRejectTask:
    ...
    def test_reject_delete_project_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_delete_project.id, "reject")
        )
    ...
    def test_reject_merge_user_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_merge_user.id, "reject")
        )
    ...
    def test_reject_set_caretaker_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_set_caretaker.id, "reject")
        )
...
class TestCancelTask:
    ...
    def test_cancel_delete_project_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_delete_project.id, "cancel")
        )
    ...
    def test_cancel_merge_user_task(self, api_client, user, admin_task_merge_user, db):
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_merge_user.id, "cancel")
        )
    ...
    def test_cancel_set_caretaker_task(
        ...
        # Act
        response = api_client.post(
            adminoptions_urls.path("tasks", admin_task_set_caretaker.id, "cancel")
        )
...
class TestRespondToCaretakerRequest:
    ...
    def test_reject_caretaker_request(self, api_client, user, secondary_user, db):
        ...
        assert not Caretaker.objects.filter(
