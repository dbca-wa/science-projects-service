...
class TestAuthenticationViews:
    ...
    def test_change_password_success(self, api_client, user, db):
        ...
        # Act
        response = api_client.put(users_urls.path('change-password'), data, format='json')
...
class TestProfileViews:
    ...
    def test_update_user_profile(self, api_client, user, user_profile, db):
        ...
        # Act
        response = api_client.put(users_urls.path('profiles', user_profile.id), data, format='json')
...
class TestStaffProfileViews:
    ...
    def test_create_staff_profile(self, api_client, user, db):
        ...
        # Act
        response = api_client.post(users_urls.path('staffprofiles'), data, format='json')
    ...
    def test_update_staff_profile(self, api_client, user, staff_profile, db):
        ...
        # Act
        response = api_client.put(users_urls.path('staffprofiles', staff_profile.id), data, format='json')
    ...
    def test_toggle_public_visibility(self, api_client, user, staff_profile, db):
        ...
        # Act
        response = api_client.post(users_urls.path('staffprofiles', staff_profile.id, 'toggle_visibility'))
...
class TestProfileSectionViews:
    ...
    def test_get_staff_profile_hero(self, api_client, staff_profile, db):
        ...
        # Act
        response = api_client.get(users_urls.path('staffprofiles', staff_profile.id, 'hero'))
    ...
    def test_get_staff_profile_overview(self, api_client, staff_profile, db):
        ...
        # Act
        response = api_client.get(users_urls.path('staffprofiles', staff_profile.id, 'overview'))
    ...
    def test_get_staff_profile_cv(self, api_client, staff_profile, db):
        ...
        # Act
        response = api_client.get(users_urls.path('staffprofiles', staff_profile.id, 'cv'))
...
class TestAdminViews:
    ...
    def test_toggle_user_active_requires_admin(self, api_client, user, user_factory, db):
...
class TestUtilityViews:
    ...
    def test_check_email_exists_true(self, api_client, user, db):
        ...
        # Act
        response = api_client.get(users_urls.path('check-email-exists'), {'email': user.email})
    ...
    def test_check_email_exists_false(self, api_client, db):
        ...
        # Act
        response = api_client.get(users_urls.path('check-email-exists'), {'email': 'nonexistent@example.com'})
    ...
    def test_check_name_exists_true(self, api_client, user, db):
        ...
        # Act
        response = api_client.get(users_urls.path('check-name-exists'), {'username': user.username})
    ...
    def test_check_name_exists_false(self, api_client, db):
        ...
        # Act
        response = api_client.get(users_urls.path('check-name-exists'), {'username': 'nonexistent'})
    ...
    def test_check_user_is_staff_true(self, api_client, user, staff_user, db):
        ...
        # Act
        response = api_client.get(users_urls.path('is_staff', staff_user.id), {'user_id': staff_user.id})
    ...
    def test_check_user_is_staff_false(self, api_client, user, user_factory, db):
        ...
        # Act
        response = api_client.get(users_urls.path('is_staff', regular_user.id), {'user_id': regular_user.id})
...
class TestStaffProfileAdvancedViews:
    ...
    def test_list_staff_profiles_with_filters(self, api_client, staff_profile, business_area, db):
    ...
    def test_check_staff_profile_exists_true(self, api_client, user, staff_profile, db):
        ...
        # Act
        response = api_client.get(users_urls.path(user.id, 'check_staff_profile'), {'user_id': user.id})
    ...
    def test_check_staff_profile_exists_false(self, api_client, user, user_factory, db):
        ...
        # Act
        response = api_client.get(users_urls.path(user.id, 'check_staff_profile'), {'user_id': other_user.id})
    ...
    def test_public_email_staff_member_dev_mode(self, api_client, staff_profile, db, settings):
        ...
        # Act
        response = api_client.post(users_urls.path(staff_profile.user.id, 'public_email_staff_member'), data, format='json')
    ...
    def test_public_email_staff_member_not_found(self, api_client, db):
        ...
        # Act
        response = api_client.post(users_urls.path(999, 'public_email_staff_member'), data, format='json')
...
class TestUserProfileAdvancedViews:
    ...
    def test_update_membership(self, api_client, user, user_work, db):
        ...
        # Act
        response = api_client.put(users_urls.path(user.id, 'membership'), data, format='json')
    ...
    def test_update_user_work(self, api_client, user, user_work, db):
        ...
        # Act
        response = api_client.put(users_urls.path('work', user_work.id), data, format='json')
    ...
    def test_update_profile_user_no_profile(self, api_client, user, user_factory, db):
        ...
        # Act
        response = api_client.put(users_urls.path(target_user.id, 'profile'), data, format='json')
