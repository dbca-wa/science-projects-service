...
from users.serializers import (  # Base serializers; Profile serializers; Staff profile serializers; Entry serializers; Update serializers
    BasicUserSerializer,
...
class TestEducationEntrySerializer:
    ...
    def test_serialize_education_entry(self, education_entry, db):
        ...
        assert (
            serializer.data["qualification_name"] == education_entry.qualification_name
        )
...
class TestUserWorkAffiliationUpdateSerializer:
    ...
    def test_serialize_affiliation_update(self, user_work, db):
        ...
        serializer = UserWorkAffiliationUpdateSerializer(
            user_work, data=data, partial=True
        )
