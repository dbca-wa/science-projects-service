...
from users.models import EducationEntry, EmploymentEntry, PublicStaffProfile
from users.services.entry_service import EducationService, EmploymentService
...
class TestUserService:
    ...
    def test_logout_user_with_url(self, mock_logout, user, db):
        ...
        request.headers.get.return_value = "https://example.com/logout"
    ...
    def test_list_users_with_business_area_filter(
        self, user, business_area, user_work, db
    ):
...
class TestProfileService:
    ...
    def test_list_staff_profiles_with_business_area_filter(
        self, staff_profile, business_area, user_work, db
    ):
