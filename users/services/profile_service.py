...
class ProfileService:
    ...
    def get_staff_profile(profile_id):
        ...
        try:
            return (
                PublicStaffProfile.objects.select_related(
                    "user",
                    "user__work",
                    "user__work__business_area",
                )
    ...
    def toggle_visibility(profile_id):
        ...
        settings.LOGGER.info(
            f"Toggled visibility for profile {profile_id}: {profile.is_hidden}"
        )
        return profile
    ...
    def check_staff_profile_exists(user_id):
        ...
        """
        try:
            profile = PublicStaffProfile.objects.select_related("user").get(
                user_id=user_id
            )
            return {
                "exists": True,
