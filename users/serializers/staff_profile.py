...
from users.models import PublicStaffProfile, KeywordTag
    ...
    def get_work(self, obj):
        if hasattr(obj.user, 'work') and obj.user.work:
            ...
            return {
                ...
                } if work.business_area else None,
            }
        return None
...
class StaffProfileCVSerializer(serializers.ModelSerializer):
    ...
    def get_employment_entries(self, obj):
        ...
        return EmploymentEntrySerializer(
            obj.employment_entries.all().order_by('-start_year'),
            many=True
        ).data
...
class StaffProfileSerializer(serializers.ModelSerializer):
    ...
    def get_user(self, obj):
        return {
            ...
            "first_name": obj.user.display_first_name,
            "last_name": obj.user.display_last_name,
            "email": obj.public_email if obj.public_email_on and obj.public_email else obj.user.email,
        }
